...
CFLAGS=-I./BOARD -I./CMSIS -I./drivers -I./utilities $(COMMONFLAGS) #donde buscar las referencias
...
SRC=$(wildcard *.c BOARD/*.c CMSIS/*.c drivers/*.c utilities/*.c) #se indican donde estan los .c a compilar
